...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if math.isnan(self.diameter):
            return f"A NearEarthObject {self.fullname} {peligroso} "
        f"potentially hazardous"
        return f"A NearEarthObject {self.fullname} has a diameter "
        f"{self.diameter}km and {peligroso} potentially hazardous"
...
class CloseApproach:
    ...
    @property
    def time_str(self):
        """Return a formatted representation of this cla approach time.
